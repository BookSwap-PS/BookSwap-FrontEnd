...
export default function CreateResenha({ route, navigation }) {
  ...
  // Função para enviar a resenha via PATCH
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        style={[styles.input, { height: inputHeight }]} // Altura dinâmica
        placeholder="Digite a sua resenha aqui"
        value={resenha}
        onChangeText={(text) => setResenha(text)}
        multiline={true}
        onContentSizeChange={(event) =>
          setInputHeight(event.nativeEvent.contentSize.height) // Ajusta a altura dinamicamente
        }
        maxLength={maxCaracteres} // Limite de caracteres
      />
